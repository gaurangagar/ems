            ...
            <form onSubmit={(e)=>{
                ...
                <div className='w-1/2'>
                    <div>
                        ...
                        className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='Make a unique design' />
                    </div>
                    <div>
